        ...
        <div class="d-flex flex-column flex-lg-row flex-column-fluid">
            ...
            <div class="d-flex flex-lg-row-fluid w-lg-50 bgi-size-cover bgi-position-center order-1 order-lg-2"
                ...
                <div class="d-flex flex-column flex-center py-15 px-5 px-md-15 w-100">
                    ...
                    <!--end::Title-->
                    <!--begin::Text-->
                    <div class="text-white fw-bold fs-base text-center">
                        Dotzone CMS is a powerful and flexible content management system that allows you to manage your
                        Website Content and E-commerce store with ease.
                    </div>
                    <!--end::Text-->
                </div>
                <!--end::Content-->
